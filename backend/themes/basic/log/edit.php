        ...
        <div id="post" class="form-group">
            ...
            <div id="post_bar">
                <div class="show_advset">
                    ...
                    <span id="asmsg"></span>
                    <input type="hidden" name="as_logid" id="as_logid" value="<?php echo $gid; ?>">
                </div>
    ...
    <div class="col-lg-4 container-side">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <input type="checkbox" value="y" name="top" id="top" <?php echo $top; ?> />
                    <label for="top">首页置顶</label>
                    <input type="checkbox" value="y" name="sortop" id="sortop" <?php echo $sortop; ?> />
                    <label for="sortop">分类置顶</label>
                    <input type="checkbox" value="y" name="allow_remark" id="allow_remark" checked="checked" <?php echo $allow_remark; ?> />
