...
<div style="margin: 0px 15px;">
    ...
    <form action="admin_log.php?action=operate_log" method="post" name="form_log" id="form_log">
        ...
        <table class="table table-striped table-bordered table-hover dataTable no-footer">
            ...
            <tr>
                ...
                <th width="49" class="tdcenter"><b><a href="">评论</a></b></th>
                <th width="59" class="tdcenter"><b><a href="">阅读</a></b></th>
            </tr>
            </thead>
            <tbody>
            <?php
            if($logs):
                foreach($logs as $key=>$value):
                    ...
                    <tr>
                        ...
                        <td width="490"><a href="<?=Url::to(['edit','gid'=>$value['gid']])?>"><?php echo $value['title']; ?></a>
                            <?php if($value['top'] == 'y'): ?><img src="<?=$this->theme->baseUrl?>/assets/images/top.png" align="top" title="首页置顶" /><?php endif; ?>
                            <?php if($value['sortop'] == 'y'): ?><img src="<?=$this->theme->baseUrl?>/assets/images/sortop.png" align="top" title="分类置顶" /><?php endif; ?>
                            <?php if($value['attnum'] > 0): ?><img src="<?=$this->theme->baseUrl?>/assets/images/att.gif" align="top" title="附件：<?php echo $value['attnum']; ?>" /><?php endif; ?>
                        ...
                        <?php if ($pid != 'draft'): ?>
                            <td class="tdcenter">
                                <a href="" target="_blank" title="在新窗口查看">
                                    <img src="<?=$this->theme->baseUrl?>/assets/images/vlog.gif" align="absbottom" border="0" /></a>
                            </td>
                        <?php endif; ?>
    ...
    <div class="page"><? //echo $pageurl; ?> (有<?php echo count($logs); ?>篇<?php echo $pid == 'draft' ? '草稿' : '文章'; ?>)</div>
</div>
<script>
