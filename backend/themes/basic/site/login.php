...
<link rel="stylesheet" href="<?= $assets?>/css/css-login.css?v=<?php echo Option::EMLOG_VERSION; ?>" type="text/css" media="screen" />
...
<div id="main" class="container">
    <form name="f" method="post" action="<?=Url::to();?>" class="form-horizontal">
        <br>
    ...
    <div class="login-ext"><?php $this->trigger(LoginForm::EVENT_AFTER_LOGIN); ?></div>
