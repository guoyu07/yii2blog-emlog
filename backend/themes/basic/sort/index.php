...
<div class=line></div>
<form  method="post" action="<?=Url::to(['taxis'])?>">
        ...
        if ($sorts):
            foreach ($sorts as $key => $value):
                ...
                <tr>
                    ...
                    <td class="sortname">
                        <a href="<?=Url::to(['edit','sid'=>$value['sid']])?>"><?php echo $value['sortname']; ?></a>
                    </td>
                    <td><?php echo $value['description']; ?></td>
                    <td class="alias"><?php echo $value['alias']; ?></td>
                    <td class="alias"><?php echo $value['template']; ?></td>
                    <td class="tdcenter">
                        <a href="" target="_blank"><img src="<?=$this->theme->baseUrl?>/assets/images/vlog.gif" align="absbottom" border="0" /></a>
                    </td>
                    <td class="tdcenter"><a href="./admin_log.php?sid=<?php echo $value['sid']; ?>"><?= count($value['blogs']); ?></a></td>
                    <td>
                        <a href="<?=Url::to(['edit','sid'=>$value['sid']])?>">编辑</a>
                        <a href="javascript: em_confirm('<?=Url::to(['del','sid'=>$value['sid']])?>', 'sort', '');" class="care">删除</a>
                    </td>
                </tr>
                <?php
                ...
                foreach ($children as $key):
                    ...
                    <tr>
                        ...
                        <td class="sortname">---- <a href="<?=Url::to(['edit','sid'=>$value['sid']])?>"><?php echo $value['sortname']; ?></a></td>
                        <td><?php echo $value['description']; ?></td>
                        <td class="alias"><?php echo $value['alias']; ?></td>
                        <td class="alias"><?php echo $value['template']; ?></td>
                        <td class="tdcenter">
...
<form action="<?=Url::to(['create'])?>" method="post" class="form-inline">
